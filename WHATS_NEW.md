...
- Create named layouts for different activities
- Save complete window arrangements with one click
- Restore entire setups instantly
- Per-layout performance settings

**Example Use Cases:**
- **"Mining Layout"**: Tight 2x2 grid, all previews small
- **"PvP Layout"**: Scouts on sides, main DPS center, enlarged
...
- **3x1 Row** - Horizontal lineup
- **1x3 Column** - Vertical stack
- **4x1 Wide** - Ultra-wide monitor setup
- **Main + Sides** - One large + 3 small
- **Cascade** - Overlapping style
- **Custom NxM** - Define your own

**Features:**
- Configurable spacing between windows
- Fill entire screen or specific monitor
- Snap-to-grid option
...
**Character Database:**
- Add ALL your characters (logged in or not!)
- Group by account (3 chars per account)
- Assign roles: Miner, Scout, DPS, Logi, Hauler, Trader
- Add notes for each character
- Track last seen/active

**Team System:**
- Create activity-based teams
- Drag-and-drop team builder
- Pre-configure for different operations
...
**Alert Actions:**
- Visual border flashing on preview
